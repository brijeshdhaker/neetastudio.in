                        ...
                        <div class="main-gallery main-model roomy-80">
                            <div class="col-md-12 m-bottom-60">
                                <div class="filters-button-group text-right sm-text-center">
                                    ...
                                    <button class="button" data-filter=".metal">Camara</button>
                                    <button class="button" data-filter=".transition">Lens</button>
                                    <button class="button" data-filter=".alkali">Drons</button>
                                    <button class="button" data-filter=".ar">Lights</button>
                                    <button class="button" data-filter=".ar">Tripods</button>
                                </div>
                            </div>
