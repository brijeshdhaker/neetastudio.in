                    ...
                    <div class="row">
                        <div class="main_home text-center">
                            <div class="about_text">
                                <h1 class="text-white text-uppercase">Timelessly Beautiful Women's Portrait</h1>
                                <ol class="breadcrumb">
                                    <li><a href="/htmls/home.php?_dc=fdfs&page=home&sTgt=site">Home</a></li>
                                    <li class="active"><a href="/htmls/portraits.php?_dc=fdfs&page=kids&sTgt=site">Portrait</a></li>
                                </ol>
                            </div>
                        </div>
                    </div><!--End off row-->
                        ...
                        <div class="main_ab_feature">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="head_title">
                                    <h2>Personalized Portrait Session</h2>
                                    <h5><em>“When words become unclear, I shall focus with photographs. When images become inadequate, I shall be content with silence.” — Ansel Adams</em></h5>
                                ...
                                <div class="ab_feature_content wow fadeIn m-top-40 animated" style="visibility: visible; animation-name: fadeIn;">
                                    <p>
                                        With 15 years of experience, we have honed our craft to provide exceptional photography services that capture 
                                        the beauty and essence of our clients. Our services include personal, matrimonial, maternity, kids, couples & family 
                                        portrait photography. We also have vast experience providing corporate headshots and personal branding photography services.
                                    </p>

                                    <p>
                                        At our studio, we have the advantage of having our own indoor and outdoor shooting spaces, allowing us to offer a wide range 
                                        of backdrops and settings to suit your needs. We pride ourselves on creating a comfortable and relaxed atmosphere during our 
                                        shoots, so you can be yourself and let your personality shine through. Please take some time to explore our website and 
                                        discover the beauty and creativity of our portfolio. We can't wait to work with you and create stunning images that will 
