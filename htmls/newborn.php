                    ...
                    <div class="row">
                        <div class="main_home text-center">
                            <div class="about_text">
                                <h1 class="text-white text-uppercase">Capturing the first days of Forever</h1>
                                <ol class="breadcrumb">
                                    <li><a href="/htmls/home.php?_dc=fdfs&page=home&sTgt=site">Home</a></li>
                                    <li class="active"><a href="/htmls/newborn.php?_dc=fdfs&page=newborn&sTgt=site">New Born</a></li>
                                </ol>
                            </div>
                        </div>
                    </div><!--End off row-->
                        ...
                        <div class="main_ab_feature">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="ab_feature_content wow fadeIn m-top-40 animated" style="visibility: visible; animation-name: fadeIn;">
                                    <p>
                                        Capture the precious moments of your newborn's arrival with delicate and heartwarming portraits. Our experienced 
                                        photographers specialise in safely and gently capturing your baby's first days and creating beautiful family 
                                        portraits that celebrate this special time.
                                    </p>
                        ...
                        <div class="main_teams">
                            <div class="col-md-12">
                                <div class="head_title text-left sm-text-center wow fadeInDown" style="visibility: hidden; animation-name: none;">
                                    <h2>Premium Newborn Shoot Packages</h2>
