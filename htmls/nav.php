            <!--Home page style-->
            <nav class="navbar navbar-default navbar-fixed white no-background bootsnav text-uppercase on no-full">
                <!-- Start Top Search -->
                ...
                <div class="container">    
                    ...
                    <div class="collapse navbar-collapse" id="navbar-menu">
                        <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                            ...
                            <li><a href="/htmls/maternity.php?_dc=fdfs&page=maternity&sTgt=site">Maternity</a></li>
