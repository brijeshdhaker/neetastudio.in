<!DOCTYPE html>
<!-- saved from url=(0055)/htmls/portfolio-details.php?_dc=fdfs&page=portfolio&sTgt=site# -->
    ...
    <body data-spy="scroll" data-target=".navbar-collapse"><div class="wrapper">
        ...
        <div class="culmn">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="teamskillbar clearfix m-top-50" data-percent="63%">
                                                ...
                                                <div class="teamskillbar-bar" style="width: 63%;"></div>
                                            </div> <!-- End Skill Bar -->
                    ...
                    <div class="row">
                        <div class="main_contact p-top-100">
                            ...
                            <div class="col-md-6 sm-m-top-30">
                                <form class="" action="https://technext.github.io/pouseidon/subcribe.php">
                                    <div class="row">
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <a href="/htmls/portfolio-details.php?_dc=fdfs&page=portfolio&sTgt=site#" class="btn btn-default">SEND MESSAGE <i class="fa fa-long-arrow-right"></i></a>
                                            </div>
                                        </div>
            ...
            <div class="scrollup" style="display: none;">
                <a href="/htmls/portfolio-details.php?_dc=fdfs&page=portfolio&sTgt=site#"><i class="fa fa-chevron-up"></i></a>
            </div>
            <!-- End off scroll up -->
